...
class LoginPage(BasePage):
    ...
    def __init__(self, page: Page):
        super().__init__(page)
        self.__username_field = self.page.locator("#user-name").describe("Username Field")
        self.__password_field = self.page.locator('[name="password"]').describe("Password Field")
        self.__login_button = self.page.locator("[data-test=login-button]")
        self._error_massage = self.page.locator("[data-test=\"error\"]").describe("Login Error Message")
        self.__login_credentials = self.page.locator("[data-test=\"login-credentials\"]").describe(
